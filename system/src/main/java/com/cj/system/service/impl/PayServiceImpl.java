...
//
//import com.cj.system.entity.Order;
//import com.cj.system.entity.pay.Pay;
//import com.cj.system.service.IPayService;
//import com.cj.system.utils.alipay.config.AlipayConfig;
//import com.cj.system.utils.alipay.util.AlipaySubmit;
...
//     */
//    @Override
//    public String getAlipay(Pay p, Order order, String goodsName, Long orderCount, BigDecimal payTotalPrice) {
...
//            outTradeNo=order1.getOrderOldCode();
//        }else{
...
//
//        // 付款金额
//        String totalFee = new String(payTotalPrice.toString());
//        // 必填
//
//        // 订单描述
//
