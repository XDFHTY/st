...
// */
//package com.cj.system.mapper.impl;
//
//import com.cj.system.entity.pay.BasicSqlSupport;
//import com.cj.system.entity.pay.Pay;
//import com.cj.system.entity.pay.SelectBean;
//import com.cj.system.mapper.PayMapper;
...
//     * @return
//     */
//    public List<Pay> selectOpenList(String isOpen) {
//        return this.selectList(
//                "com.ningpai.system.dao.PayMapper.selectByIsOpen", isOpen);
//    }
//    /**
//     * 根据id修改默认
//     *
//     * @see com.ningpai.system.dao.PayMapper#changeDefaultToNO(Long)
//     */
//    @Override
...
//
//        return this.selectOne(
//                "com.ningpai.system.dao.PayMapper.findTotalCountByPayType",selectBean);
//    }
//
//    /**
//     * 根据支付类型查询为微信支付的接口
...
//        return this.selectList("com.ningpai.system.dao.PayMapper.selectMobilePay");
//    }
//
//    /**
//     * 查询微信的支付接口
...
//        return this.selectOne("com.ningpai.system.dao.PayMapper.selectWxPay");
//    }
//
//    /**
//     * 根据支付类型查询支付方式
...
//        return this.selectOne("com.ningpai.system.dao.PayMapper.selectPayByType", type);
//    }
//}
